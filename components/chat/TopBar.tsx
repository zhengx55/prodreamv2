...
const NavItem = ({ icon, label }: { icon: string; label: string }) => {
  ...
  return (
    <div
      className={`flex cursor-pointer items-center space-x-2 rounded-[8px] px-6 py-2 ${isSelected
    ...
    >
      ...
      <span
        className={`font-poppins text-base font-normal capitalize leading-5 tracking-[0.16px] text-[#57545E] ${isSelected
...
const TopBar = () => (
  <div className='bg-secondary flex justify-center py-2 pr-5'>
