    ...
    >
      ...
      <div className='flex gap-x-3'>
        ...
        >
          ...
          <h2 className='base-regular text-zinc-800'>AI Reserach</h2>
          <p className='subtle-regular text-center text-neutral-400'>
            Ask a research question and get supporting sources
          </p>
        </div>
        <div
          role='button'
        ...
        >
          ...
          <h2 className='base-regular text-zinc-800'>ChatPDF</h2>
          <p className='subtle-regular text-center text-neutral-400'>
            Click or drag to upload Chat with file & get summaries
          </p>
        </div>
      </div>
    </m.div>
