      ...
      <div className='flex items-center gap-x-4'>
        ...
        {['basic', 'free_trail'].includes(usage?.subscription ?? '') ? (
          <Button
            ...
            className='h-max rounded bg-violet-500 px-2 py-1 hover:bg-doc-secondary hover:text-violet-500'
          >
            <Diamond /> Upgrade
          </Button>
        ) : null}
        {/* <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button className='p-2 bg-transparent text-black hover:bg-doc-secondary hover:text-violet-500'>
