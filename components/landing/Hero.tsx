...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        <section className='flex w-full flex-col sm:w-[1200px]'>
          ...
          <Spacer y='20' />
          <p className='small-regular text-[14px] text-[#64626A] text-center sm:text-[32px] sm:text-center'>
          ...
          <div className='relative flex w-full flex-col items-center justify-center gap-x-0 gap-y-4 pl-2 sm:flex-row sm:items-start sm:gap-x-2 sm:gap-y-0'>
            <Button
              asChild
              className='h-max w-2/3 rounded-[8px] sm:w-max sm:px-8 sm:py-3.5'
            >
              <Link href={'/signup'}>
            ...
            <Button
              className='h-max w-2/3 rounded-[8px] text-[#9C2CF3] border border-[#9C2CF3] sm:w-max sm:px-8 sm:py-3.5'
              variant={'ghost'}
            >
              Join Community
            </Button>
