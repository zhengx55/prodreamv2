    ...
    <section className='relative flex w-full flex-col items-center justify-center px-4 py-10 sm:px-0 sm:py-20'>
      <CaptureProvider event='ScreenV'>
        <h2 className=' inline-flex font-custom text-[24px] leading-relaxed sm:text-[48px]'>
          <Image
            src='/landing/heros/Quote_mark.svg'
            alt='qutes'
            width={50}
            height={50}
      ...
      <Spacer y='20' />
      <ul className='flex w-full flex-col gap-y-8 rounded-xl bg-violet-500/5 py-16 sm:h-[450px] sm:w-[1200px] sm:flex-row sm:gap-y-0'>
        {CommentsInfo.map((comment, index) => (
          ...
          >
            <p className='text-[18px] leading-relaxed text-[#3B3A40]'>
