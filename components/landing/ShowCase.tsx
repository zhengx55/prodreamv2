      ...
      <div className='flex-center w-full flex-col gap-y-10 sm:max-w-[1410px]'>
        ...
        >
          <div className='flex w-full flex-col sm:flex-row'>
            ...
            <h1 className='ml-4 text-left font-baskerville text-[28px] font-[400] tracking-tighter sm:text-left sm:text-[72px]'>
              Loved by students of all majors and backgrounds
            </h1>
          </div>
          <div className='mt-[20px] flex w-full flex-col rounded-[8px] bg-[#F5F6F9] px-[4px] py-[8px] sm:mt-[60px] sm:flex-row sm:rounded-[36px] sm:px-[24px] sm:py-[48px]'>
            {datalist.map((item, index) => (
              <div
                className={`${index < 2 ? 'border-b border-[#D1D0D6] sm:border-b-0 sm:border-r' : ''} mb-[20px] w-full p-[35px] sm:mb-0 sm:w-1/3 sm:px-[26px]`}
                key={item.name}
              >
                <p className='text-[14px] text-[#3B3A40] text-[400] sm:text-[20px]'>
                  {item.desc}
                </p>
                <div className='mt-[30px] flex'>
                  ...
                  <div className='ml-[12px] sm:ml-[18px]'>
                    <h5 className='text-[16px] font-[700] text-[#3B3A40]'>
                      {item.name}
                    </h5>
        ...
        <div className='sm:mb-[100px] sm:pt-[200px]'>
          <h1 className='text-center font-baskerville text-[28px] font-[400] sm:text-center sm:text-[72px]'>
            Every Writing Scenario,
            <br />{' '}
            <span className='relative inline-block before:absolute before:-inset-1 before:top-[16px] before:z-[-1] before:block before:h-[40%] before:-skew-y-0 before:bg-[#F2C8FB] sm:before:top-[46px]'>
              Masterfully
            </span>{' '}
            Covered
          </h1>
          <p className='small-regular text-center text-[#64626A] sm:w-[98%] sm:text-center sm:text-[28px]'>
            We cover all academic writing needs, from detailed research papers
            to engaging essays, with excellence in every word.
          </p>
        </div>
        <m.div
          initial='hidden'
        ...
        >
          <m.div className='flex w-full flex-col items-center gap-y-2 sm:w-1/2'>
            <div>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                width='40'
              ...
              >
                <path
                  d='M10.0221 6.66309C6.34047 6.66309 3.35547 9.64808 3.35547 13.3297V26.6631C3.35547 30.3447 6.34047 33.3297 10.0221 33.3297L15.0371 33.3464C15.7471 33.3464 16.4905 33.6731 17.3421 34.4581C17.6738 34.7647 18.0705 35.1481 18.3405 35.5064C18.6405 35.9064 19.0321 36.6681 20.0221 36.6631C21.0121 36.6581 21.3338 35.9847 21.6888 35.5164C21.9571 35.1864 22.2788 34.8714 22.6105 34.5648C23.4638 33.7798 24.3122 33.3297 25.0222 33.3297H30.0222C33.7038 33.3297 36.6888 30.3447 36.6888 26.6631V13.3297C36.6888 9.64808 33.7038 6.66309 30.0222 6.66309H25.0222C23.0038 6.66309 21.2455 7.58976 20.0221 9.00643C18.7988 7.58976 17.0405 6.66309 15.0221 6.66309H10.0221ZM10.0221 9.99642H15.0221C16.8638 9.99642 18.3555 11.4881 18.3555 13.3297L18.3655 31.078C17.3255 30.403 16.2088 29.9964 15.0221 29.9964H10.0221C8.18047 29.9964 6.6888 28.5047 6.6888 26.6631V13.3297C6.6888 11.4881 8.18047 9.99642 10.0221 9.99642ZM25.0222 9.99642H30.0222C31.8638 9.99642 33.3555 11.4881 33.3555 13.3297V26.6631C33.3555 28.5047 31.8638 29.9964 30.0222 29.9964H25.0222C23.8355 29.9964 22.7222 30.4247 21.6822 31.0997L21.6888 13.3297C21.6888 11.4881 23.1805 9.99642 25.0222 9.99642Z'
                  fill='#8551F3'
                />
              </svg>
            </div>
            <div className='py-1'>
              <h5 className='sm:h2-bold text-center text-[16px] font-[600] sm:text-[36px]'>
                Research Papers
              </h5>
              <p className='small-regular text-center text-[#64626A] sm:w-full sm:text-[28px]'>
          ...
          <m.div className='flex w-full flex-col items-center sm:h-[515px] sm:w-1/2'>
            <div>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                width='40'
            ...
            <div className='py-1'>
              ...
              <p className='small-regular text-center text-[#64626A] sm:w-full sm:text-[28px]'>
                Analytical clarity meets depth in your case studies, courtesy of
                our targeted AI insights
              </p>
            </div>
            <Spacer y='136' />
            <div>
