  ...
  return (
    <AnimatePresence>
      <m.section
        ...
        className='flex-center flex flex-1 flex-col'
      >
        {type === 'language' ? (
          <>
            ...
            <p className='base-regular max-w-[1000px] text-center font-[400] text-[#525252]'>
              Could you share if English is your native language or if
              you&apos;re studying in English as a second language? Your
              response will help us ensure our services best fit your linguistic
