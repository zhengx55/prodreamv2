...
const ActivityListTut = () => {
  ...
  return (
    <>
      <div className='mt-4 flex h-[calc(100vh_-200px)] shrink-0 overflow-y-auto rounded-lg bg-sectionBackground px-4 py-6'>
          ...
          {currnetIndex === 0 ? (
            ...
            >
              ...
              <p className='small-regular'>
                ...
                and create a draft for you to edit or add any missing
                activities.
              </p>
              <Image
                alt='act-tut'
            ...
            >
              ...
              <p className='small-regular'>
                😋 Let the magic happen! Select the list(s) you want to
                generate, this could be UC Application, Common App or a list
                with customized character limits.
              </p>
              <Image
                alt='act-tut'
              ...
              <p className='small-regular'>
                😚 Click the Edit (Pen) button to finalize your list. Use Power
                Up to boost the writing quality of the activity description. You
                can also use Fit to character limit to shorten the description.
              </p>
              <Image
                alt='act-tut'
