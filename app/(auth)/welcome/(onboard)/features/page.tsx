...
export default async function Page() {
  ...
  return (
    <AnimatedLayout>
      <div className='relative w-full rounded-[20px] bg-[#fff] px-[200px] py-[100px]'>
